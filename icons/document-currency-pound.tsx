...
export interface DocumentCurrencyPoundIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface DocumentCurrencyPoundIconProps
...
const DocumentCurrencyPoundIcon = forwardRef<
  DocumentCurrencyPoundIconHandle,
  DocumentCurrencyPoundIconProps
