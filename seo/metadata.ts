...
const baseMetadata: Metadata = {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `${SITE.NAME} - Animated Heroicons Library for React`,
      },
    ],
  },
  ...
  title: {
    default: `${SITE.NAME} | Free Animated Heroicons for React`,
  ...
  twitter: {
    ...
    title: `${SITE.NAME} | Free Animated Heroicons for React`,
    description: SITE.DESCRIPTION.SHORT,
