...
export interface Cog8ToothIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface Cog8ToothIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const Cog8ToothIcon = forwardRef<Cog8ToothIconHandle, Cog8ToothIconProps>(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <path d="M15 12C15 13.6568 13.6569 15 12 15C10.3431 15 9 13.6568 9 12C9 10.3431 10.3431 8.99999 12 8.99999C13.6569 8.99999 15 10.3431 15 12Z" />
        </motion.svg>
      </div>
    );
  }
