...
export interface Cog6ToothIconHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface Cog6ToothIconProps extends HTMLAttributes<HTMLDivElement> {
  size?: number;
}

const Cog6ToothIcon = forwardRef<Cog6ToothIconHandle, Cog6ToothIconProps>(
    ...
    return (
      ...
      >
        ...
        >
          ...
          <path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3432 10.3431 9.00001 12 9.00001C13.6569 9.00001 15 10.3432 15 12Z" />
        </motion.svg>
      </div>
    );
  }
