...
export const generateMetadata = async ({
  ...
  const title = `${keyword} Icon - Animated Icon for React`;
  const description = `Free animated ${icon.name} icon for React. Smooth animations, copy-paste ready. Keywords: ${icon.keywords.slice(0, 5).join(", ")}.`;
